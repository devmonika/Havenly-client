        ...
        <form>
          <div>
            ...
            <div class="mt-1 rounded-md shadow-sm">
              <input id="text" name="text" type="text" required autofocus class="appearance-none block w-full px-3 py-2 border border-secondary rounded-md placeholder-gray-400 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
            </div>
          </div>
          ...
          <div class="mt-6">
            ...
            <div class="mt-1 rounded-md shadow-sm">
              <input id="text" type="file" required class="appearance-none block w-full px-3 py-2 border border-secondary rounded-md placeholder-gray-400 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
            </div>
          </div>
          <div class="mt-6">
            ...
            <div class="mt-1 rounded-md shadow-sm">
              <textarea id="text" type="text" required class="appearance-none block w-full px-3 py-2 border border-secondary rounded-md placeholder-gray-400 transition duration-150 ease-in-out sm:text-sm sm:leading-5"></textarea>
            </div>
          </div>
          <div class="mt-6">
            <span class="block w-full rounded-md shadow-sm">
              <button type="submit" class="flex justify-center w-full px-4 py-2 text-sm font-medium text-white bg-secondary border border-transparent rounded-md hover:bg-primary focus:outline-none transition duration-150 ease-in-out mb-24">Update</button>
            </span>
          </div>
        </form>
      </div>
