            ...
            <div className="">
                ...
                <div className="bg-blue-50 p-5">
                    <div className="sm:flex sm:justify-between">
                        ...
                        <button onClick={() => handleDeleteWishlist(wish)} className="inline-flex items-center mt-3 sm:mt-0 px-4 py-2 bg-red-500 hover:bg-red-600 text-white text-sm font-medium rounded-md">
