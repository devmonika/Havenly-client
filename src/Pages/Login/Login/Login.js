...
const Login = () => {
    ...
    return (
        <div className='grid grid-cols-1  sm:grid-cols-2 h-screen w-full  bg-[#1E293B]'>
            <div>
            ...
            <div className=' flex flex-col  p-6 rounded-md sm:p-10 bg-[#1E293B] text-white-900 mt-24'>
                <div className='mb-8 text-center'>
                    <h1 className='my-3 text-4xl font-bold text-secondary'>Login Now!</h1>
                ...
                >
                    ...
                    <div className="form-control mt-4">
                        <input className="btn bg-secondary text-white" type="submit" value="login" />

                    </div>
                    {/* loginerror */}
                    <div className='text-red-500'>
                        {
                            loginError && <p>password at least 6 charecters</p>
                        }
                    </div>
                ...
                <div className='flex justify-center  '>
                    <div className=' mb-4'>
                        <button
                            ...
                            aria-label='Log in with Google' className='p-3 rounded-sm text-secondary'>
                            <svg
                ...
                <div>
                    <p className='px-6 text-sm text-center text-gray-400'>Don't have an account yet? {' '}
                        <Link to='/signup' className='hover:underline text-gray-400'>Sign Up</Link></p>
                </div>
            </div>
        </div>
