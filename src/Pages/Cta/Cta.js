    ...
    return (
        ...
        <div className="2xl:mx-auto dark:bg-gray-900 2xl:container md:py-12 py-9">
            <div className="relative">
                <img src="https://i.ibb.co/SBpL1cK/pexels-aleksandar-pasaric-325185-1.png" alt="city view" className="w-full h-full   object-center object-fill absolute sm:block hidden" />
                <img src="https://i.ibb.co/LQpxBsc/mobile.png" alt="city view" className="w-full h-full  absolute object-center object-fill sm:hidden" />
                <div className="text-xl relative z-20 bg-gradient-to-r from-primary to-transparent w-full h-full top-0 md:p-16 p-6 flex flex-col justify-between ">
                    ...
                    <div className="md:mt-12 mt-20">
                        <button className="text-base font-bold leading-4 text-primary bg-secondary sm:w-auto w-full rounded p-4 focus:outline-none hover:bg-gray-100 focus:ring-2 focus:ring-offset-2 focus:ring-white">Contact Us</button>
                    </div>
                </div>
            </div>
        </div>
